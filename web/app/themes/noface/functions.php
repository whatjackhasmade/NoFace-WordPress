...
class StarterSite extends Timber\Site
{
    ...
    public function __construct()
    {
        ...
        add_filter('post_type_link', [$this, 'shapeofweb_remove_cpt_slug'], 10, 3);
        add_action('pre_get_posts', [$this, 'shapeofweb_parse_request_trick']);
        parent::__construct();
    }
    ...
    public function shapeofweb_remove_cpt_slug($post_link, $post, $leavename)
    {
        if ('case-study' != $post->post_type || 'publish' != $post->post_status) {
            return $post_link;
        }
    ...
    public function shapeofweb_parse_request_trick($query)
    {
        ...
        if (!empty($query->query['name'])) {
            $query->set('post_type', array('post', 'page', 'case-study'));
        }
    }
